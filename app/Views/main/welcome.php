...
<head>
    ...
    <style>
        body {
            /* background-image:url(https://unsplash.it/1920/1080?image=1); */
            ...
            /* background-image: url(https://images.unsplash.com/photo-1533327325824-76bc4e62d560?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=869&q=80); */
...
<body>
    <div class="container">
        ...
        <div class="button-container">
            <button class="button"><?php echo anchor('adminlogin', 'Admin Login', ['style' => 'text-decoration: none; color: white;']); ?></button>
            <button class="button"><?php echo anchor('login', 'Student Login', ['style' => 'text-decoration: none; color: white;']); ?></button>
        </div>
    </div>
</body>
