...
<body>
    <div class="signup-form">
        <h2>Welcome Admin</h2>
        <form action="<?= base_url('adminsave'); ?>" method="post" autocomplete="off">
        <!-- <?= csrf_field() ?> -->
        ...
        <!-- <input type="text" name="adminID" placeholder="Admin ID" value=""> -->
        ...
        <input type="text" name="cpassword" placeholder="Confirm Password" value="<?= set_value('cpassword') ?>">
        <span class="text-danger"><?= isset($validation)? display_error($validation, 'cpassword'): '' ?></span>
        <input type="submit" value="Sign Up">
            <br>
            <br>
            <a href="<?php echo site_url('adminlogin') ?>"  style="color: white">Already have an account? Login</a>
        </form>
    </div>
</body>
</html>
